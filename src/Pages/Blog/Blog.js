...
const Blog = () => {
    return (
        <div>
            ...
            <h2>Ques 02:Why are you using firebase? What other options do you have to implement authentication?
            </h2>
            <p>Answer: Firebase helps you make your app the best it can be with tools for the entire journey. Get your app up and running quickly & securely with fully managed backend infrastructure. Release Apps Confidently. Trusted by +200,000 Devs. Accelerate Development.Usually, authentication by a server entails the use of a user name and password. Other ways to authenticate can be through cards, retina scans, voice recognition, and fingerprints</p>
            <h2>Ques 03: How does the private route work?</h2>
            ...
            <h2>Ques 04: What is Node? How does Node work?</h2>
